...
@push('styles')
<style>
    /* ── ADMIN NOTIFIKASI PAGE STYLING ── */
    .notif-page-card {
        background: #fff;
        border-radius: var(--radius, 14px);
        box-shadow: 0 2px 14px rgba(15, 34, 53, 0.07);
...
@php
    ...
    $backUrl = ($referrer && $referrer !== url()->current()) ? $referrer : route('admin.dashboard');
@endphp
...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <p class="text-muted small mb-0">Kelola dan tinjau seluruh riwayat notifikasi admin</p>
        </div>
    </div>
